...
Ext.define("AmpsDasboard.util.Utilities", {
              ...
              },
              {
                ...
                listeners: {
                  beforerender: function (scope) {
                    ...
                    var fields = services.commonFields.concat(
                      services.types.find((el) => el.type == "subscriber")
                        .fields
                    );
            ...
            bbar: [
              ...
              },
              {
                ...
                handler: async function (scope) {
                  ...
                  action = amfutil.grids["actions"].addProcess(
                    action,
                    actionform
                  );
                  ...
                  var topicid = await amfutil.addToCollection("topics", topic);
                  console.log(topicid);
  ...
  grids: {
    ...
    accounts: {
      ...
      columns: [
        ...
        { text: "Given Name", dataIndex: "given_name", flex: 1, type: "text" },
        { text: "Surname", dataIndex: "surname", flex: 1, type: "text" },
        ...
        {
          text: "UFA Home Folder",
          dataIndex: "ufahome",
          flex: 1,
          type: "text",
        },
        {
          text: "Configuration Polling Interval",
          dataIndex: "cinterval",
          flex: 1,
        },
        {
          text: "Heartbeat Polling Interval",
          dataIndex: "hinterval",
          flex: 1,
        },
        { text: "Log File Path", dataIndex: "logpath", flex: 1, type: "text" },
        {
          text: "Debug Logging",
          dataIndex: "debug",
          flex: 1,
          ...
          update: function (record, route, tbar, back, scope) {
            ...
            if (record.fmeta) {
              ...
              fmeta.forEach(function (def) {
                ...
                var d = Ext.create("AmpsDasboard.form.FileMetaData");
      ...
      fields: [
        ...
        },
        {
          ...
          listeners: {
            beforerender: function (scope) {
              scope.setStore(
                Object.entries(amfutil.actionTypes).map((entry) => entry[1])
              );
            },
            change: function (scope, value) {
              ...
              amfutil.actionTypes[value].fields.forEach((field) => {
                console.log(field);
    ...
    services: {
      ...
      types: [
        ...
        //             formpanel.insert(
        //               formpanel.items.length - 1,
        //               Ext.create("AmpsDasboard.form.Keys", {
        //                 name: "modules",
        //                 label: "Module",
        //               })
        //             );
        ...
        //       var length = dcon.items.length;
        //       var d = Ext.create("AmpsDasboard.form.Keys", {
        //         name: "modules",
        //         label: "Module",
        //       });
    ...
    keys: {
      ...
      create: function () {
        ...
        var win = Ext.create("AmpsDasboard.form.add");
        win.loadForm(
          "Key",
          [
            {
        ...
        win.loadForm("Subscriber", [
...

          {
            ...
            listeners: {
              beforerender: async function (scope) {
                scope.setStore(
                  amfutil.createCollectionStore("actions", { active: true })
                );
              },
            },
          },
        ...
        myForm.loadForm("Key", [
          ...
          },
          {
            ...
            listeners: {
              beforerender: async function (scope) {
                scope.setStore(
                  amfutil.createCollectionStore("topics", { active: true })
                );
              },
            },
          },
    ...
    //   actionIcons: ["addnewbtn", "searchpanelbtn", "clearfilter", "refreshbtn"],
    //   columns: [
    //     { text: "Rule Name", dataIndex: "name", flex: 1, type: "text" },
    //     { text: "Rule Type", dataIndex: "rtype", flex: 1, type: "text" },
    //     { text: "File Polling Interval", dataIndex: "fpoll", flex: 1 },
    //     {
    //       text: "Failure Retry Wait",
    //       dataIndex: "fretry",
    //       flex: 1,
    //       hidden: true,
    //     },
    //     { text: "Regex Flag", dataIndex: "regex", flex: 1, hidden: true },
    //     { text: "File Match Pattern", dataIndex: "fmatch", flex: 1 },
    //     {
    ...
    //     },
    //     {
    //       text: "Upload Bucket Path",
    //       dataIndex: "bpath",
    //       flex: 1,
    //       hidden: true,
    //     },
    //     { text: "Acknowledgment Mode", dataIndex: "ackmode", flex: 1 },
    //     { text: "Active", dataIndex: "active", flex: 1, hidden: true },
    //     {
    //       text: "Folder Name",
    //       dataIndex: "movetofolder_name",
    //       flex: 1,
    //       hidden: true,
    //       type: "text",
    //     },
    ...
    //     { text: "Rule Name", dataIndex: "name", flex: 1, type: "text" },
    //     { text: "Rule Type", dataIndex: "rtype", flex: 1, type: "text" },
    //     { text: "Bucket Polling Interval", dataIndex: "bpoll", flex: 1 },
    //     {
    //       text: "Get Failure Retry Wait",
    //       dataIndex: "bretry",
    //       flex: 1,
    //       hidden: true,
    //     },
    //     { text: "Bucket Name", dataIndex: "bucket", flex: 1, type: "text" },
    //     {
    //       text: "Bucket Path Prefix",
    //       dataIndex: "prefix",
    //       flex: 1,
    //       type: "text",
    //     },
    //     {
    //       text: "Download Folder Name",
    //       dataIndex: "folder",
    //       flex: 1,
    //       type: "text",
    //     },
  ...
  actionTypes: {
                ...
                items: [
                  {
                    ...
                    handler: function (button, event) {
                      ...
                      formpanel.insert(
                        formpanel.items.length - 1,
                        Ext.create("AmpsDasboard.form.Parm.Bool")
                      );
                    },
                  },
                  {
                    ...
                    handler: function (button, event) {
                      ...
                      formpanel.insert(
                        formpanel.items.length - 1,
                        Ext.create("AmpsDasboard.form.Parm.String")
                      );
                    },
                  },
                ],
      ...
      load: function (form, record) {
        ...
        parms.forEach(function (p) {
          ...
          if (typeof p.value === "boolean") {
            var d = Ext.create("AmpsDasboard.form.Parm.Bool");
            d.down("#field").setValue(p.field);
            d.down("#value").setValue(p.value);
            dcon.insert(length - 1, d);
          } else {
            var d = Ext.create("AmpsDasboard.form.Parm.String");
            d.down("#field").setValue(p.field);
            d.down("#value").setValue(p.value);
            dcon.insert(length - 1, d);
          }
      ...
      fields: [
        {
          ...
          listeners: {
            beforerender: function (scope) {
              scope.setStore(
                amfutil.createCollectionStore("mailbox_auth", {
                  active: "true",
                })
              );
            },
    ...
    router: {
      ...
      load: function (form, record) {
        ...
        var ruleCont = form.down("formrules");
        rules.forEach((rule) => {
          ruleCont.addRule(rule);
        });
      },
      ...
      fields: [
        {
          ...
          name: "partner_key",
          store: Ext.create("AmpsDasboard.store.Key"),
          // listeners: {
          //   beforerender: async function (scope) {
    ...
    sftpput: {
      ...
      fields: [
        ...
        },
        {
          ...
          listeners: {
            beforerender: async function (scope) {
              var data = await amfutil.getCollectionData("accounts");

              scope.setStore(data.map((el) => el.username));
            },
          },
        },
      ],
  ...
  getCurrentItem: async function (route) {
    let response = await amfutil.ajaxRequest({
      url: "/api/" + route ? route : Ext.util.History.getToken(),
      headers: {
        Authorization: localStorage.getItem("access_token"),
      },
      method: "GET",
  ...
  showActionIcons: function (providedRoute) {
    ...
    if (page) {
      ...
      console.log(amfutil.grids[route].actionIcons);
      amfutil.showButtons(amfutil.grids[route].actionIcons);
    }
  ...
  showFieldIcons: function (collection, field) {
    ...
    var items = amfutil.grids[collection].subgrids[field].actionIcons;
  ...
  hideAllButtons: function () {
    ...
    var routes = Object.keys(amfutil.grids);
  ...
  createFieldSearch: function (route, field, grid) {
    var items =
      amfutil.grids[route].subgrids[field].columns &&
      amfutil.grids[route].subgrids[field].columns.map((field) => {
        if (field.type) {
      ...
      buttons: [
        {
          ...
          handler: function (btn) {
            ...
            var fields = form.getFields();
            var values = form.getValues();
            var fields = amfutil.grids[route].subgrids[field].columns;
  ...
  createFormFilter: function () {
    ...
    var items =
      amfutil.grids[route].columns &&
      amfutil.grids[route].columns.map((field) => {
        if (field.type) {
          return filterTypes[field.type](field);
        } else {
          return;
      ...
      buttons: [
        {
          ...
          handler: function (btn) {
            ...
            var fields = form.getFields();
            var values = form.getValues();
            var fields = amfutil.grids[route].columns;
            // var fieldKeys = fields.map((field) => field.field);
            console.log(fields);
            console.log(values);
            var filters = {};
